...
public class MybatisConfig {
    ...
    @Configuration
    @MapperScan(basePackages = "cn.zhh.mapper",sqlSessionTemplateRef = "sqlSessionTemplate")
    ...
    @Configuration
    @MapperScan(basePackages = "cn.zhh.mapper2",sqlSessionTemplateRef = "sqlSessionTemplate2")
